...
class TrainOptions(BaseOptions):
    ...
    def initialize(self, parser):
        ...
        # training parameters
        parser.add_argument('--n_epochs', type=int, default=100 1, help='number of epochs with the initial learning rate')
        ...
        parser.add_argument('--gan_mode', type=str, default='vae',
                            help='the type of GAN objective. [dcgan | vae].')
